...
let MsgModalBuilder = function(){
    ...
    const UI = {
        WRAP : function(containerId, modalId, width) {
            ...
            $modal = $(`<div id="modal-background" onclick="backgroundClickRemove();"><span class="blind">모달백그라운드</span></div>`)
            $inner = $(`<div id="msgModalWrap"></div>`);
        ...
        BODY : function(content) {
            if(typeof content !== 'string') {
                let body = $(`<div id="msgModalBody"><div id="modal-txt"></div></div>`);
		...
		ALERT_BODY : function(content) {
			let alertBody = $(`<div id="msgModalBody"><div id="alert-img"><img src="/../images/alert.png" alt="경고"></div><div id="modal-txt"></div></div>`);
			if(content !== null){
		...
		SUCCESS_BODY : function(content) {
			let alertBody = $(`<div id="msgModalBody"><div id="alert-img"><img src="/../images/success.png" alt="성공"></div><div id="modal-txt"></div></div>`);
			if(content !== null){
				alertBody.find('#modal-txt').append(`${content}`)
			}
			return alertBody;
...
function backgroundClickRemove() {
