package com.sri.lanka.traffic.webapp.config.authentication.admin;
...
@Data
public class AdminAuthenticationEntity extends LoginMngrDTO implements UserDetails{
    ...
    public AdminAuthenticationEntity(LoginMngrDTO authLoginDTO) {
